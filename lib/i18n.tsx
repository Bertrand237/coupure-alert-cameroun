...
const translations = {
  fr: {
    ...
    reportIncident: 'Signaler une panne',
    incidentType: 'Type de panne',
    brokenPipe: 'Tuyau cassé',
    fallenPole: 'Poteau tombé',
    cableOnGround: 'Câble au sol',
    otherIncident: 'Autre',
    comment: 'Commentaire (optionnel)',
    commentHint: 'Décrivez la panne...',
    incidents: 'Incidents',
    incident: 'Incident',
    outages: 'Coupures',
    ...
    confirmIncident: 'Confirmer cet incident',
    incidentSaved: 'Votre incident a été enregistré.',
    tipOfDay: 'Astuce du jour',
    myNeighborhood: 'Mon quartier aujourd\'hui',
    noNearbyEvents: 'Aucun événement récent à proximité',
    newOutage: 'Nouvelle coupure',
    ...
    restorationReminder: 'Rappel de rétablissement',
    isOutageStillActive: 'La coupure est-elle toujours en cours ?',
    yesStillActive: 'Oui, toujours',
    noRestored: 'Non, rétablie',
    allEvents: 'Tous',
    regions: {
      adamaoua: 'Adamaoua',
      centre: 'Centre',
  ...
  en: {
    ...
    fallenPole: 'Fallen pole',
    cableOnGround: 'Cable on ground',
    otherIncident: 'Other',
    comment: 'Comment (optional)',
    commentHint: 'Describe the incident...',
    incidents: 'Incidents',
    incident: 'Incident',
    outages: 'Outages',
    infrastructure: 'Infrastructure',
    ...
    confirmIncident: 'Confirm this incident',
    incidentSaved: 'Your incident has been recorded.',
    tipOfDay: 'Tip of the day',
    myNeighborhood: 'My neighborhood today',
    noNearbyEvents: 'No recent events nearby',
    newOutage: 'New outage',
    newIncident: 'New incident',
    distanceAway: '%s km away',
    ...
    restorationReminder: 'Restoration reminder',
    isOutageStillActive: 'Is the outage still active?',
    yesStillActive: 'Yes, still active',
    noRestored: 'No, restored',
    allEvents: 'All',
    regions: {
      adamaoua: 'Adamaoua',
      centre: 'Centre',
